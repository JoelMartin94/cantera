...
void PureFluidReactor::initialize(doublereal t0)
{
...
size_t PureFluidReactor::componentIndex(const string& nm) const
{
...
std::string PureFluidReactor::componentName(size_t k) {
    if (k == 2) {
        return "temperature";
    } else {
